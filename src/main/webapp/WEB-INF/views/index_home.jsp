                ...
                <div class="navbar navbar-custom navbar-static-top" role="navigation">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="${contextPath}/index">GENESIS' Path</a>
                            <i class="brand_network"><small><small>MyProfile</small></small></i>
                        </div>
...
<div>
<blockquote><p>
     <h2 align="center" style="font-family: Verdana,sans-serif;color:#1C3B47;">Motivated to Keep Learning ..</h2>
...
<div class="w3-content w3-padding" style="max-width:1564px">
  ...
  <div class="container w3-padding-32" id="about">
    ...
    <div class="w3-content" style="max-width:700px">
	    <p style="text-align:justify;"> Welcome to my DevOps corner! With a solid foundation in cloud technologies and a strong commitment to continuous learning, I’m a DevOps engineer passionate about building, automating, and optimizing solutions that drive efficiency and resilience in the tech world. Certified in AWS Solutions Architect, CKA, and Hashicorp,  I specialize in leveraging cloud infrastructure, CI/CD, and containerization practices to empower modern development workflows
	    </p>
	    <p><strong>Address:</strong>  Newark NJ</p> 
	    <p><strong>linkedin: </strong>https://www.linkedin.com/in/genesisn/ </p>
		<p><strong>E-Mail ID :</strong>  04_bronze.squirm.com</p>
  	</div>
   </div>
  ...
  <div class="container w3-padding-32" id="contact">
    ...
    <p>Lets get in touch and talk about your job and our next project.</p>
...
<footer class="w3-center  w3-padding-16" style="background-color:#1C3B47 ">
  <p style="color:#FFFFFF ">Copyright @2017 <a href="#"  target="_blank" class="w3-hover-text-green"> mafike.com</a></p>
</footer>
