    ...
    <div class="row">
                ...
                <div class="navbar navbar-custom navbar-static-top" role="navigation">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="#">mafike info</a>
                            <i class="brand_network"><small><small>mfk* Network</small></small></i>
                        </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-7">
                                                        ...
                                                        <p class="text-muted small">
                                                            ${pageContext.request.userPrincipal.name}mafike.com</p>
                                                        <div class="divider">
                                                        </div>
                ...
                <div class="panel-body">
                    <div class="media">
                        ...
                        <div class="media-body">
                            ...
                            <p>DevOps For Product Management and Strategy of Application Delivery. Responsible of providing customers with counsel on their DevOps strategies to help them deliver higher quality software and services to market faster.</p>
                            <hr>
        ...
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12">
            <div class="panel panel-default">
                <div class="panel-body">
                    <span>
                        <h1 class="panel-title pull-left" style="font-size:30px;">${pageContext.request.userPrincipal.name} &nbsp; <small>${pageContext.request.userPrincipal.name}@mafike.com</small> <i class="fa fa-check text-success" aria-hidden="true" data-toggle="tooltip" data-placement="bottom" title=" sharing with you"></i></h1>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-body">
                                ...
                                <div class="post-content">
                                    ...
                                    <p>I believe demand for people with DevOps skills is growing rapidly because businesses get great results from DevOps. Organizations using DevOps practices are overwhelmingly high-functioning: They deploy code up to 30 times more frequently than their competitors.</p>
                                </div>
                            </div>
                        </div>
                    </div>
