                ...
                <div class="navbar navbar-custom navbar-static-top" role="navigation">
                    <div class="container-fluid">
                        <div class="navbar-header">
                            ...
                            <a class="navbar-brand" href="${contextPath}/index">WARMUP Project</a>
                            <i class="brand_network"><small><small>Just hire the boy</small></small></i>
                        </div>
...
<div class="container">
    ...
    <form method="POST" action="${contextPath}/login" class="form-signin">
		...
		<img  class="logo" src="${contextPath}/resources/Images/mafiketech-logo.png" />
